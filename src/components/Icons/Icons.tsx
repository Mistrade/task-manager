...
export const ChildOfIcon: FC<IconProps & FlexBlockProps> = ({
	...
	return (
		<FlexBlock {...props} align={'center'} justify={'center'}>
			<svg width="380" height="358" viewBox="0 0 380 358" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect width="380" height="358" fill="white"/>
				<rect x="20" y="20" width="340" height="50" rx="12" fill="white"/>
				<rect x="21" y="21" width="338" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				...
				<rect x="81" y="88" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="96.4706" y="95" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="96.4706" y="115" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="80" y="154" width="280" height="50" rx="12" fill="white"/>
				<rect x="81" y="155" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="96.4706" y="162" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="96.4706" y="182" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="140" y="221" width="220" height="50" rx="12" fill="white"/>
				<rect x="141" y="222" width="218" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="152.941" y="229" width="194.118" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="152.941" y="249" width="194.118" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="140" y="288" width="220" height="50" rx="12" fill="white"/>
				<rect x="141" y="289" width="218" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="152.941" y="296" width="194.118" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="152.941" y="316" width="194.118" height="14" rx="7" fill="#D9D9D9"/>
				<line x1="60.7757" y1="69.9995" x2="60.7757" y2="179" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
				<line x1="60" y1="111" x2="80" y2="111" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
				<line x1="60" y1="178" x2="80" y2="178" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
				<line x1="121.224" y1="204" x2="121.224" y2="313" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
				<line x1="120.449" y1="245" x2="140.449" y2="245" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
				<line x1="120.449" y1="312" x2="140.449" y2="312" stroke="#1E1E1E" strokeOpacity="0.1" strokeWidth="2"/>
			</svg>
		</FlexBlock>
	)
}
	...
	return (
		<FlexBlock {...props} align={'center'} justify={'center'}>
			<svg width="380" height="266" viewBox="0 0 380 266" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<rect x="21" y="26" width="338" height="214" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="30" y="50" width="320" height="65" rx="12" fill="white"/>
				<rect x="31" y="51" width="318" height="63" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="48.8235" y="60.4" width="282.353" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="48.8235" y="86.4" width="282.353" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="30" y="151" width="320" height="65" rx="12" fill="white"/>
				<rect x="31" y="152" width="318" height="63" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="48.8235" y="161.4" width="282.353" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="48.8235" y="187.4" width="282.353" height="18.2" rx="9.1" fill="#D9D9D9"/>
			</svg>
		</FlexBlock>
	)
}
	...
	return (
		<FlexBlock {...props} align={'center'} justify={'center'}>
			<svg width="380" height="266" viewBox="0 0 380 266" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<rect x="86" y="56" width="258" height="63" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="100.294" y="65.4" width="229.412" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="100.294" y="91.4" width="229.412" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="85" y="146" width="260" height="65" rx="12" fill="white"/>
				<rect x="86" y="147" width="258" height="63" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="100.294" y="156.4" width="229.412" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<rect x="100.294" y="182.4" width="229.412" height="18.2" rx="9.1" fill="#D9D9D9"/>
				<path
...
export const ApprovedAfterIcon: FC<IconProps & FlexBlockProps> = ({
	...
	return (
		<FlexBlock {...props} align={'center'} justify={'center'}>
			<svg width="441" height="358" viewBox="0 0 441 358" fill="none" xmlns="http://www.w3.org/2000/svg">
				<rect width="441" height="358" fill="white"/>
				<rect x="79" y="20" width="340" height="50" rx="12" fill="white"/>
				<rect x="80" y="21" width="338" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				...
				<path d="M42 30C50.2843 30 57 36.7157 57 45" stroke="#6495ED" strokeWidth="4" strokeLinecap="round"/>
				<rect x="139" y="87" width="280" height="50" rx="12" fill="white"/>
				<rect x="140" y="88" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="155.471" y="95" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="155.471" y="115" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<path
				...
				<rect x="140" y="155" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="155.471" y="162" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="155.471" y="182" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="139" y="221" width="280" height="50" rx="12" fill="white"/>
				<rect x="140" y="222" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="155.471" y="229" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="155.471" y="249" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="139" y="288" width="280" height="50" rx="12" fill="white"/>
				<rect x="140" y="289" width="278" height="48" rx="11" stroke="#6495ED" strokeOpacity="0.9" strokeWidth="2"/>
				<rect x="155.471" y="296" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
				<rect x="155.471" y="316" width="247.059" height="14" rx="7" fill="#D9D9D9"/>
			</svg>
