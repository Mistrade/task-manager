...
export const DefaultWebIcon: FC<IconProps & FlexBlockProps> = ( {
                                                                  size = 24,
                                                                  color = currentColor,
                                                                  ...props
                                                                } ) => {
