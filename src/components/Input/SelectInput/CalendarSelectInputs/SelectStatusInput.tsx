...
import {CalendarPriorityKeys, CalendarPriorityList, TaskStatusesType} from "../../../../pages/Planner/planner.types";
import {FlexBlockProps} from "../../../LayoutComponents/FlexBlock";
import {FC, useMemo} from "react";
import {PRIORITY_LIST, PRIORITY_TITLES, TaskStatusesList, TaskStatusesTitles} from "../../../../common/constants";
...
interface SelectStatusInputProps extends Partial<Omit<DefaultTextInputProps, 'onChange'>> {
...
export const SelectStatusInput: FC<SelectStatusInputProps> = ({
	...
	const Statuses: Array<{ type: EventFilterTaskStatuses, title: string }> = useMemo(() => {
