...
const margins: CustomMixin<MarginProps> = (_) => css`
  ${_.mt
    ? css`
        margin-top: ${pxToCssValue(_.mt)};
      `
    : ''}
  ${_.mr
    ? css`
        margin-right: ${pxToCssValue(_.mr)};
      `
    : ''}
  ${_.mb
    ? css`
        margin-bottom: ${pxToCssValue(_.mb)};
      `
    : ''}
  ${_.ml
    ? css`
        margin-left: ${pxToCssValue(_.ml)};
      `
    : ''}
  ${_.m
    ? css`
        margin: ${pxToCssValue(_.m)};
      `
    : ''}
`;
...
const paddings: CustomMixin<PaddingProps> = (_) => css`
  ${_.pt
    ? css`
        padding-top: ${pxToCssValue(_.pt)};
      `
    : ''}
  ${_.pr
    ? css`
        padding-right: ${pxToCssValue(_.pr)};
      `
    : ''}
  ${_.pb
    ? css`
        padding-bottom: ${pxToCssValue(_.pb)};
      `
    : ''}
  ${_.pl
    ? css`
        padding-left: ${pxToCssValue(_.pl)};
      `
    : ''}
  ${_.p
    ? css`
        padding: ${pxToCssValue(_.p)};
      `
    : ''}
`;
...
const widths: CustomMixin<WidthProps> = (_) => css`
  ${_.width
    ? css`
        width: ${pxToCssValue(_.width)};
      `
    : ''}
  ${_.maxWidth
    ? css`
        max-width: ${pxToCssValue(_.maxWidth)};
      `
    : ''}
  ${_.minWidth
    ? css`
        min-width: ${pxToCssValue(_.minWidth)};
      `
    : ''}
`;
...
const heights: CustomMixin<HeightProps> = (_) => css`
  ${_.height
    ? css`
        height: ${pxToCssValue(_.height)};
      `
    : ''}
  ${_.maxHeight
    ? css`
        max-height: ${pxToCssValue(_.maxHeight)};
      `
    : ''}
  ${_.minHeight
    ? css`
        min-height: ${pxToCssValue(_.minHeight)};
      `
    : ''}
`;
...
const formalization: CustomMixin<FormalizationProps> = (_) => css`
  ...
  ${_.borderTop
    ? css`
        border-top: ${_.borderTop};
      `
    : ''}
  ${_.borderRight
    ? css`
        border-right: ${_.borderRight};
      `
    : ''}
  ${_.borderBottom
    ? css`
        border-bottom: ${_.borderBottom};
      `
    : ''}
  ${_.borderLeft
    ? css`
        border-left: ${_.borderLeft};
      `
    : ''}
  ${_.borderRadius
    ? css`
  ...
  ${_.overflowX
    ? css`
        overflow-x: ${_.overflowX};
      `
    : ''}
  ${_.overflowY
    ? css`
        overflow-y: ${_.overflowY};
      `
    : ''}
  ${_.transform
    ? css`
...
const fonts: CustomMixin<FontsProps> = (_) => css`
  ${_.fSize
    ? css`
        font-size: ${pxToCssValue(_.fSize)};
      `
    : css`
        font-size: 16px;
      `}
  ${_.fWeight
    ? css`
        font-weight: ${pxToCssValue(_.fWeight)};
      `
    : ''}
  ${_.textAlign
    ? css`
