...
export class DateScopeHelper {
  ...
  private getDateScopeOfMonthIncludeAdditionalDates(
    dateInMonth: Date
  ): DateScopeInterface {
  ...
  public getDateScopeOfYear(dateInYear: Date): DateScopeInterface {
    return {
      startDate: DateHelper.getFirstDayInYear(
  ...
  private getDateScopeForTaskSchemeOfMonthPattern(
    dateForScheme: Date
  ): TaskSchemeDateScopeInterface {
  ...
  private getDateScopeForTaskSchemeOfYearPattern(
    dateForScheme: Date
  ): TaskSchemeDateScopeInterface {
    const firstDayInYear = DateHelper.getFirstDayInYear(
      dateForScheme.getFullYear()
    );
  ...
  public getDateScopeForTaskScheme(
    dateForScheme: Date,
    schemeType: 'month' | 'year'
  ): TaskSchemeDateScopeInterface {
