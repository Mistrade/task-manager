...
export const TaskComments: FC<TaskCommentsProps> = ({taskInfo}) => {
	...
	const [updateCommentItem, setUpdateCommentItem] = useState<null | CommentModel>(null)
	...
	const onUpdateCommentClick = useCallback((item: CommentModel) => {
	...
	const onReplyComment = useCallback((value: CommentModel) => {
