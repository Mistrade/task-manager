...
import {CommentActionButton, CommentActionsContainer} from "../comments.styled";
import {Tooltip} from "../../../../../../../components/Tooltip/Tooltip";
import {PencilIcon, StarIcon, TrashIcon} from "../../../../../../../components/Icons/Icons";
import {currentColor, defaultColor, orangeColor} from "../../../../../../../common/constants";
		...
		<CommentActionsContainer>
			...
			{comment.editable && (
				<Tooltip content={'Редактировать текст комментария'}>
					<CommentActionButton
						onClick={() => onUpdateCommentClick && onUpdateCommentClick(comment)}
					>
						<PencilIcon size={16}/>
					</CommentActionButton>
				</Tooltip>
