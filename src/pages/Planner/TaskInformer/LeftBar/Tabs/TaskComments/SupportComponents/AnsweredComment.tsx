...
export interface AnsweredCommentProps {
	...
	onClick?: (e: React.MouseEvent<HTMLDivElement>, sourceEventId: ObjectId) => void
}

export const AnsweredComment: FC<AnsweredCommentProps> = ({commentItem, onDelete, onClick}) => {
	...
	return (
		<FlexBlock direction={'row'} align={'flex-start'} gap={6} width={'100%'} style={{cursor: 'pointer'}}>
			<AnswerIcon/>
