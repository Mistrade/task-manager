...
import {FlexBlock, FlexBlockProps} from "../../../../../../../components/LayoutComponents/FlexBlock";
import {ParentOfIcon} from "../../../../../../../components/Icons/Icons";
...
export const ConnectChainsCard: FC<ConnectChainsCardProps> = ({icon, title, description, type}) => {
	return (
		<FlexBlock
			width={'100%'}
			height={'100%'}
		...
		>
			...
			<FlexBlock justify={'flex-start'} bgColor={pageHeaderColor} width={'100%'} p={12} gap={12}
								 direction={'column'}
								 grow={3}>
				<Heading.H3 style={{color: currentColor, textAlign: 'center'}}>
					{title}
				</Heading.H3>
				<FlexBlock fSize={15} justify={'center'} style={{color: darkColor, textAlign: 'center'}}>
					{description}
				</FlexBlock>
			</FlexBlock>
		</FlexBlock>
