...
export const ConnectTypesArray: Array<ConnectChainsCardObject> = [
	{
		type: "parentOf",
		title: "ParentOf (dev)",
		description: "Свяжите текущее событие, с другим, которое станет родителем для текущего",
		icon: (attr) => <ParentOfIcon {...attr}/>
	},
	{
		type: 'childOf',
		title: "ChildOf (dev)",
		description: "Добавьте вложенные события, за прогрессом которых сможете следить из раздела \"Связи\"",
		icon: (attr) => <ChildOfIcon {...attr} />
	},
	{
		type: "completed-after",
		title: "CompletedAfter (dev)",
		description: "Установите автоматическое выполнение текущего события, как только будут выполнены все выбранные события для этого типа связи",
		icon: (attr) => <CompletedAfterIcon {...attr} />
	},
	{
		type: "approved-after",
		title: "ApprovedAfter (dev)",
		description: "Установите условие, которое не позволит выполнить текущее событие, пока не будут выполнены все события в этом типе связи",
