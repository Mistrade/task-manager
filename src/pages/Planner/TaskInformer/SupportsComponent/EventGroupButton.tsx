...
export const EventGroupButton: FC<EventGroupButtonProps> = forwardRef<HTMLButtonElement, EventGroupButtonProps>((props, ref) => {
				...
				>
					<FlexBlock gap={6} align={'center'} fSize={15} style={{color: darkColor}}>
						{props.isLoading ? (
							...
							<GroupLogo color={props.group?.color || defaultColor} {...props.iconProps}/>
						)}
						{props.renderText && (props.group?.title || "Группа событий не выбрана")}
					</FlexBlock>
				</EmptyButtonStyled>
			</Tooltip>
		)
