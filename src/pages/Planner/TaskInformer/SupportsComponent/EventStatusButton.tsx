...
export const EventStatusButton: FC<EventStatusButtonProps> = forwardRef<HTMLButtonElement, EventStatusButtonProps>(
	(props, ref) => {
				...
				<Tooltip
					content={
						props.tooltipInfo && props.tooltipInfo !== 'default'
							? props.tooltipInfo
							: `Статус события: ${TASK_STATUSES[props.status || 'created'].title}`
					}
				>
					<EmptyButtonStyled
