...
import {useRemoveEventMutation, useUpdateTaskMutation} from "../../../../store/api/planning-api";
import {EventInfoModalProps} from "../../planner.types";
import {TransparentButton, WhiteButton} from "../../../../components/Buttons/Buttons.styled";
...
export const TaskInformerMoreActions: FC<TaskInformerMoreActionsProps> = ({
	...
	const [removeTask, {data: removeTaskData, isLoading: isFetchingRemoveTask}] = useRemoveEventMutation()
			...
			content={
				<SelectListContainer>
					<SelectItemContainer
						onClick={(e) => {
							e.stopPropagation()
							taskItem && onCloneEvent && onCloneEvent({
								...taskItem,
