...
import {useCreateEventMutation, useGetGroupsListQuery} from "../../../../store/api/planning-api";
...
export const CreateEventForm: FC<CreateEventFormProps> = ({date, onComplete, onCancel, initialValues, groupsList}) => {
		...
		<form onSubmit={formik.handleSubmit} style={{width: '100%', height: '100%'}}>
			<FlexBlock direction={'column'} height={'100%'}>
				<FlexBlock
					...
					width={'100%'}
				>
					<Heading.H2 style={{fontWeight: 'normal', marginBottom: 8}}>Создайте новое событие</Heading.H2>
					<FlexBlock gap={12} p={`4px 8px`} border={`1px solid ${disabledColor}`} borderRadius={borderRadiusSize.sm}>
						<ToggleEventCalendar
