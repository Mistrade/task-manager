import {Modal, ModalBody, ModalFooter, ModalHeader} from "../../../components/LayoutComponents/Modal/Modal";
import {FC, useEffect} from "react";
import {FlexBlock} from "../../../components/LayoutComponents/FlexBlock";
import {colorPalette, currentColor} from "../../../common/constants";
import {useFormik} from "formik";
import * as yup from 'yup'
import {ColorScheme} from "../../../components/ColorScheme/ColorScheme";
import {TextInput} from "../../../components/Input/TextInput/TextInput";
import {useCreateEventGroupMutation, useUpdateGroupInfoMutation} from "../../../store/api/planning-api";
...
import {CustomRtkError, MyServerResponse} from "../../../store/api/rtk-api.types";
...
export const CreateOrUpdateGroupModal: FC<ChangeGroupModalProps> = ({onClose, isEditing, initialValues}) => {
			...
			if (!isEditing) {
				return await create(values)
					...
					.catch((e: CustomRtkError) => {
						return e.data.info ? toast(e.data.info.message, {type: e.data.info.type}) : null
					})
			}
			...
			>
				<ModalHeader>
					<FlexBlock align={'center'} justify={'flex-start'} gap={12}>
						<FlexBlock fSize={20}>
							{!isEditing ? 'Создайте новую группу событий' : 'Измените группу событий'}
						</FlexBlock>
					</FlexBlock>
				</ModalHeader>
				<ModalBody>
