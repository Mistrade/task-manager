...
import {planningApi, useUpdateTaskMutation} from "../../../../../store/api/planning-api";
...
import {ContinueTaskButtonGroup} from "../../../../../components/Buttons/ContinueTaskButtons/ContinueTaskButtonGroup";
...
export const DayTaskItem: FC<DayTaskItemProps> = ({
	...
	const updateTaskHandler: EventInfoUpdateFn = useCallback(async (field, data) => {
