...
import {CalendarDateListContainer, CalendarDesktopContainer} from '../../Planner.styled'
...
export const MonthCalendar: FC<MonthCalendarProps> = ({
	...
	const {filters, SwitcherBadges, TaskStorage, handlers, isFetching} = useEventStorage({
