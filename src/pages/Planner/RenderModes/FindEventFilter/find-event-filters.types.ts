...
export type OnFocusEventHandlers = (fieldName: keyof EventFiltersProps, e: React.FocusEvent<HTMLInputElement>) => void
export type EventFilterTaskStatuses = 'in_work' | 'completed' | 'archive' | "created" | 'all'
